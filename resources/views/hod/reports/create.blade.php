...
@section('content')
    <div class="max-w-3xl">
        ...
        <x-card title="New Report">
            <form method="POST" action="{{ route('hod.reports.store') }}" enctype="multipart/form-data">
                @csrf
                ...
                <div class="flex items-center gap-3 mt-8 pt-5 border-t border-gray-100">
                    ...
                    <a href="{{ route('hod.reports.index') }}" class="text-sm text-gray-500 hover:text-gray-700 ml-auto">Cancel</a>
                </div>
            </form>
        </x-card>
    </div>
