...
@section('content')
        ...
        <div class="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4">
            <div>
                ...
                <div class="flex flex-wrap items-center gap-4 mt-3 text-sm text-gray-500">
                    <span>Created {{ $proposal->created_at->format('M d, Y \a\t g:i A') }}</span>
                </div>
            </div>

            <div class="flex items-center gap-2 shrink-0">
                @can('update', $proposal)
                    <x-button variant="secondary" size="sm" :href="route('staff.proposals.edit', $proposal)">
                ...
                <x-share-kingschat-button
                    ...
                    :url="route('staff.proposals.show', $proposal)"
                    type="proposal"
                    variant="secondary"
                />
    ...
    <div class="mt-6" x-data="commentsSection({{ $proposal->id }})">
        <x-card>
            ...
            @can('create', [App\Models\Comment::class, $proposal])
            ...
            @else
                <div class="mb-6 p-4 bg-gray-50 border border-gray-200 rounded-lg">
                    <p class="text-sm text-gray-600">
                        ...
                        Only administrators can add comments to proposals.
                    </p>
                </div>
            @endcan
